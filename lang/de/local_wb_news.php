...
$string['btnlinkattributes'] = 'Button-Link-Attribute';
$string['btnlinkblank'] = 'Öffnet den Link in einem neuen Tab oder Fenster';
$string['btnlinknofollow'] = 'Weist Suchmaschinen an, dem Link nicht zu folgen';
$string['btnlinknoopener'] = 'Verhindert, dass die neue Seite auf die Eigenschaft "window.opener" zugreifen kann';
$string['btnlinknoreferrer'] = 'Verhindert, dass der Browser den HTTP-Referer-Header sendet';
$string['btnlinkparent'] = 'Öffnet den Link im übergeordneten Frame';
...
$string['deleteinstance_desc'] = 'Bestätige des Löschens aller Artikel und der Instanz';
...
$string['restrictednewsitem'] = 'Sie haben keinen Zugriff auf diesen News-Eintrag.';
$string['restrictioncohorts'] = 'Sichtbar fuer Mitglieder von Kohorten';
$string['restrictioncohorts_help'] = 'Wenn leer, ist der Beitrag fuer alle mit Ansichtsrecht sichtbar.';
$string['restrictioncohortsmatch'] = 'Kohorten-Bedingung';
$string['restrictioncohortsmatchall'] = 'Benutzer muss in allen ausgewaehlten Kohorten sein';
